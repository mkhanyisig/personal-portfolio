    ...
    <section className={` ${bgColor} py-2`} id="competencies">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div
            className={`service text-center p-6 ${sectionBackground} border-b rounded-b-lg shadow-lg`}
          >
            ...
            <h4 className={`text-xl font-semibold mb-2 ${textColor}`}>
              Backend Development
            </h4>
            <p className={`${textColor}`} style={{ textAlign: 'left' }}>
              I wield a diverse skill set spanning various languages and
              frameworks for Web servers and other types of task automation as
              well. Beyond server-side applications, I’ve scripted functions for
              various tasks that consume different libraries or API integrations
              including third parties, and managed data persistence across SQL
              and NoSQL databases. My deployment proficiency extends to AWS
              cloud services, as well as Docker containerization with exposed
              REST endpoints.
            </p>
            <br />
            <p className={`${textColor}`} style={{ textAlign: 'left' }}>
              I approach problems methodically, adhering to best practices and
              design patterns to ensure robust scalability and performance.
              Experienced in API integration and crafting bespoke solutions
              expanding functionality, including writing controller functions,
              and leveraging third-party services. I’ve contributed to both
              monolithic( including MVC) and microservice architectures,
              including serverless deployments.{' '}
            </p>
            <br />
            <p className={`${textColor}`} style={{ textAlign: 'left' }}>
              My capabilities encompass optimizing data structures, service
              calls, and database operations while prioritizing security best
              practices.
            </p>
          </div>
          <div
          ...
          >
            ...
            <p className={`${textColor}`} style={{ textAlign: 'left' }}>
              I am proficient in developing intuitive and visually appealing
              user interfaces, bringing the intended aesthetic and
              responsiveness of a page to life. I have collaborated closely with
              designers and product stakeholders to translate mockups and
              wireframes into polished front-end implementations that align with
              the intended user experience on the client side.
            </p>
            <br />
            <p className={`${textColor}`} style={{ textAlign: 'left' }}>
              With a strong foundation in vanilla HTML, CSS, and JavaScript, I
              have also honed my skills and worked using in modern front-end
              frameworks such as React.js. My expertise extends to creating
              responsive designs that deliver exceptional user experiences
              across various devices and screen sizes. Additionally, I possess a
              keen eye for detail and a commitment to optimizing performance and
              accessibility standards to ensure that front-end applications are
          ...
          >
            ...
            <p className={`${textColor}`} style={{ textAlign: 'left' }}>
              ...
              solving both within the business context and beyond, including Applied Machine Learning/Gen AI
              solutions. I bring a full-stack mindset and take strong
        ...
        <div className="mt-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div
              className={`skills-category text-center ${sectionBackground} p-6 border-b rounded-lg shadow-lg`}
            >
            ...
            <div
              className={`skills-category text-center ${sectionBackground} p-6 border-b rounded-b-lg shadow-lg`}
            >
              <h3 className={`text-xl font-semibold mb-4 ${textColor}`}>
